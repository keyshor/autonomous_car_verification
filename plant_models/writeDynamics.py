...
for i in range(NUM_RAYS):
    plant[reg1 + 4]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg1 + 5]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg1 + 6]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
plant[reg2]['transitions'][(reg2, reg2 + 6)]['guards1'] = ['clock = 0',
                                                           'theta_l >= -1', 'theta_l <= 1']
plant[reg2]['transitions'][(reg2, reg2 + 6)]['reset1'] = ['clock\' := 0',
                                                          'temp1\' := 0', 'temp2\' := 0']
plant[reg2]['transitions'][(reg2, reg2 + 7)] = {}
plant[reg2]['transitions'][(reg2, reg2 + 7)]['guards1'] = ['clock = 0', 'theta_l >= 1']
plant[reg2]['transitions'][(reg2, reg2 + 7)]['reset1'] = ['clock\' := 0',
                                                          'temp1\' := 0', 'temp2\' := 0']
plant[reg2]['transitions'][(reg2, reg2 + 7)]['guards2'] = ['clock = 0', 'theta_l <= -1']
plant[reg2]['transitions'][(reg2, reg2 + 7)]['reset2'] = ['clock\' := 0',
                                                          'temp1\' := 0', 'temp2\' := 0']

# temp1 = arctan(theta_l) // theta_l \in [-1, 1]
plant[reg2 + 6] = {}
plant[reg2 + 6]['name'] = '_arc_3_1_'
...
for i in range(NUM_RAYS):
    plant[reg2 + 6]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
plant[reg2 + 6]['invariants'] = ['clock <= 0']
plant[reg2 + 6]['transitions'] = {}
plant[reg2 + 6]['transitions'][(reg2 + 6, reg2 + 9)] = {}
plant[reg2 + 6]['transitions'][(reg2 + 6, reg2 + 9)
                               ]['guards1'] = ['clock = 0', 'theta_r <= 1', 'theta_r >= -1']
plant[reg2 + 6]['transitions'][(reg2 + 6, reg2 + 9)
                               ]['reset1'] = ['clock\' := 0', 'theta_l\' := temp1']
...
plant[reg2 + 6]['transitions'][(reg2 + 6, reg2 + 10)
                               ]['reset2'] = ['clock\' := 0', 'theta_l\' := temp1']

# theta_l = (1 / theta_l)  // theta_l \in [-\infty, -1] or [1, \infty]
plant[reg2 + 7] = {}
plant[reg2 + 7]['name'] = '_div_1_1_'
...
for i in range(NUM_RAYS):
    plant[reg2 + 7]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg2 + 8]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg2 + 9]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg2 + 10]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg2 + 11]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg3 + 11]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg3 + 12]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg3 + 13]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg3 + 14]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
for i in range(NUM_RAYS):
    plant[reg3 + 15]['dynamics']['_f' + str(i + 1)] = '_f' + str(i + 1) + '\' = 0\n'
...
plant[reg3 + 15]['transitions'][(reg3 + 15, mode1_reg3)]['reset1'] = [
    'clock\' := 0',
    'theta_r\' := ' +
    str(np.pi) + ' - (' +
    str(np.pi/2.0) + ' - temp2)',
...
plant[reg3 + 15]['transitions'][(reg3 + 15, mode1_reg3)]['reset2'] = [
    'clock\' := 0',
    'theta_r\' := ' +
    str(np.pi) + ' - (-' +
    str(np.pi/2.0) + ' - temp2)',
...
while curRay <= NUM_RAYS:
    ...
    plant[mode1_reg1 + index]['transitions'][(mode1_reg1 + index, mode1_reg1 + index + 2)]['reset1'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG1)//NUM_MODES_REG1) + '\' := 0', 'angle\' := angle']
    ...
    plant[mode1_reg1 + index +
          1]['transitions'][(mode1_reg1 + index + 1, mode1_reg1 + index + 4)]['guards1'] = ['clock = 0']
    plant[mode1_reg1 + index +
          1]['transitions'][(mode1_reg1 + index + 1, mode1_reg1 + index + 4)]['reset1'] = ['clock\' := 0']

    # compute sec(angle)
    plant[mode1_reg1 + index + 4] = {}
    plant[mode1_reg1 + index + 4]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg1 + index + 5]['name'] = '_div_0_0_'
    ...
    plant[mode1_reg1 + index + 6]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg1 + index + 7]['name'] = '_div_0_0_'
    ...
    plant[mode1_reg1 + index + 7]['transitions'][(mode1_reg1 + index + 7, mode1_reg1 + index + 10)]['reset1'] = [
        'clock\' := 0', '_f' + str((index + NUM_MODES_REG1)//NUM_MODES_REG1) + '\' := angle * y2']    
    ...
    plant[mode1_reg1 + index + 8]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg1 + index + 9]['name'] = '_div_0_0_'
...
while curRay <= NUM_RAYS:
    ...
    plant[mode1_reg2 + index +
          1]['transitions'][(mode1_reg2 + index + 1, mode1_reg2 + index + 5)]['guards1'] = ['clock = 0']
    plant[mode1_reg2 + index +
          1]['transitions'][(mode1_reg2 + index + 1, mode1_reg2 + index + 5)]['reset1'] = ['clock\' := 0']

    #
    plant[mode1_reg2 + index + 5] = {}
    plant[mode1_reg2 + index + 5]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg2 + index + 6]['transitions'][(mode1_reg2 + index + 6, mode1_reg2 + index + 13)]['guards1'] = ['clock = 0', ' temp1 >= 0']
    ...
    plant[mode1_reg2 + index + 6]['transitions'][(mode1_reg2 + index + 6, mode1_reg2 + index + 13)]['guards2'] = ['clock = 0', ' temp1 <= 0']
    plant[mode1_reg2 + index + 6]['transitions'][(mode1_reg2 + index + 6, mode1_reg2 + index + 13)]['reset2'] =\
    ...
    plant[mode1_reg2 + index + 2]['transitions'][(mode1_reg2 + index + 2, mode1_reg2 + index + 7)] = {}
    plant[mode1_reg2 + index + 2]['transitions'][(mode1_reg2 + index + 2, mode1_reg2 + index + 7)]['guards1'] = ['clock = 0']
    plant[mode1_reg2 + index + 2]['transitions'][(mode1_reg2 + index + 2, mode1_reg2 + index + 7)]['reset1'] = ['clock\' := 0']

    #
    plant[mode1_reg2 + index + 7] = {}
    plant[mode1_reg2 + index + 7]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg2 + index + 8]['transitions'][(mode1_reg2 + index + 8, mode1_reg2 + index + 13)]['guards1'] = ['clock = 0', 'temp1 >= 0']
    plant[mode1_reg2 + index + 8]['transitions'][(mode1_reg2 + index + 8, mode1_reg2 + index + 13)]['reset1'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG2)//NUM_MODES_REG2) + '\' := (' +
         str(HALLWAY_WIDTH) + ' - y2) * angle']
    plant[mode1_reg2 + index + 8]['transitions'][(mode1_reg2 + index + 8, mode1_reg2 + index + 13)]['guards2'] = ['clock = 0', 'temp1 <= 0']
    plant[mode1_reg2 + index + 8]['transitions'][(mode1_reg2 + index + 8, mode1_reg2 + index + 13)]['reset2'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG2)//NUM_MODES_REG2) + '\' := ' + str(LIDAR_MAX_DISTANCE)]        
    ...
    plant[mode1_reg2 + index + 9]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg2 + index + 10]['transitions'][(mode1_reg2 + index + 10, mode1_reg2 + index + 13)]['guards1'] =\
                                                 ['clock = 0', 'temp1 >= 0']
    plant[mode1_reg2 + index + 10]['transitions'][(mode1_reg2 + index + 10, mode1_reg2 + index + 13)]['reset1'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG2)//NUM_MODES_REG2) + '\' := y2 * angle']
    plant[mode1_reg2 + index + 10]['transitions'][(mode1_reg2 + index + 10, mode1_reg2 + index + 13)]['guards2'] =\
                                                 ['clock = 0', 'temp1 <= 0']
    plant[mode1_reg2 + index + 10]['transitions'][(mode1_reg2 + index + 10, mode1_reg2 + index + 13)]['reset2'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG2)//NUM_MODES_REG2) + '\' := ' + str(LIDAR_MAX_DISTANCE)]        
    ...
    plant[mode1_reg2 + index + 11]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg2 + index + 12]['transitions'][(mode1_reg2 + index + 12, mode1_reg2 + index + 13)]['guards1'] =\
                                                 ['clock = 0', 'temp1 >= 0']
    ...
    plant[mode1_reg2 + index + 12]['transitions'][(mode1_reg2 + index + 12, mode1_reg2 + index + 13)]['guards2'] =\
                                                 ['clock = 0', 'temp1 <= 0']
    plant[mode1_reg2 + index + 12]['transitions'][(mode1_reg2 + index + 12, mode1_reg2 + index + 13)]['reset2'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG2)//NUM_MODES_REG2) + '\' := ' + str(LIDAR_MAX_DISTANCE)]        
...
while curRay <= NUM_RAYS:
    ...
    plant[mode1_reg3 + index +
          1]['transitions'][(mode1_reg3 + index + 1, mode1_reg3 + index + 5)]['guards1'] = ['clock = 0']
    plant[mode1_reg3 + index +
          1]['transitions'][(mode1_reg3 + index + 1, mode1_reg3 + index + 5)]['reset1'] = ['clock\' := 0']

    #
    plant[mode1_reg3 + index + 5] = {}
    plant[mode1_reg3 + index + 5]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg3 + index + 6]['name'] = '_div_0_0_'
    ...
    plant[mode1_reg3 + index + 6]['transitions'][(mode1_reg3 + index + 6, mode1_reg3 + index + 13)]['reset1'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG3)//NUM_MODES_REG3) + '\' := (' +
         str(HALLWAY_WIDTH) + ' - y2) * angle']    
    ...
    plant[mode1_reg3 + index + 7]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg3 + index + 8]['name'] = '_div_0_0_'
    ...
    plant[mode1_reg3 + index + 8]['transitions'][(mode1_reg3 + index + 8, mode1_reg3 + index + 13)]['reset1'] =\
        ['clock\' := 0', '_f' + str((index + NUM_MODES_REG3)//NUM_MODES_REG3) + '\' := y2 * angle']    
    ...
    plant[mode1_reg3 + index + 9]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg3 + index + 10]['name'] = '_div_0_0_'
    ...
    plant[mode1_reg3 + index + 11]['name'] = '_cos_0_0_'
    ...
    plant[mode1_reg3 + index + 12]['name'] = '_div_0_0_'
    ...
    plant[mode1_reg3 + index + 13]['transitions'][(mode1_reg3 + index + 13, mode1_reg3 + index + NUM_MODES_REG3)]['guards1'] =\
        ['clock = 0', '_f' + str((index + NUM_MODES_REG3)//NUM_MODES_REG3) + ' >= ' + str(LIDAR_MAX_DISTANCE)]
