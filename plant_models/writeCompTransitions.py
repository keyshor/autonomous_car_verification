...
trans['dnn2plant'] = {}
trans['dnn2plant'][1] = {}
trans['dnn2plant'][1]['guards1'] = ['clock = 0', '_f1 <= ' + str(MAX_TURNING_INPUT), '_f1 >= ' + str(-MAX_TURNING_INPUT)]
trans['dnn2plant'][1]['reset1'] = ['clock\' := 0', 'u\' := ' + str(PIBY180) + ' * _f1']
trans['dnn2plant'][1]['guards2'] = ['clock = 0', '_f1 >= ' + str(MAX_TURNING_INPUT)]
trans['dnn2plant'][1]['reset2'] = ['clock\' := 0', 'u\' := ' + str(PIBY180 * MAX_TURNING_INPUT)]
trans['dnn2plant'][1]['guards3'] = ['clock = 0', '_f1 <= ' + str(-MAX_TURNING_INPUT)]
